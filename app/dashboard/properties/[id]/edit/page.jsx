...
export default function EditPropertyPage() {
  ...
  const isResidential =
    form.category === "homes" || form.category === "long-term";
  ...
  const handlePhotos = (e) => {
    ...
    if (valid.length !== picked.length) {
      setErrorMessage("Each photo must be an image file and 5 MB or smaller.");
      setStatus("error");
    }
  ...
  const handleSubmit = async (e) => {
    ...
    const { error: listingError } = await supabase
      ...
      .update({
        ...
        bedrooms: isResidential && form.bedrooms ? Number(form.bedrooms) : null,

        bathrooms:
          (isResidential || isCommercial) && form.bathrooms
        ...
        square_feet:
          isCommercial && form.square_feet ? Number(form.square_feet) : null,

        commercial_use: isCommercial ? form.commercial_use || null : null,

        lease_type: isCommercial ? form.lease_type || null : null,
      ...
      <main className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <section className="bg-white border border-slate-200 rounded-2xl p-6 sm:p-8 space-y-5">
            ...
            <Field label="Rules / Policies" hint="Separate rules with commas.">
              <input
                value={form.rules}
          ...
          <section className="bg-white border border-slate-200 rounded-2xl p-6 sm:p-8 space-y-5">
            ...
            <p className="text-sm text-slate-500">
              The customer uploads their own photos here. The first photo
              becomes the cover image. Up to 10 images, 5 MB each.
            </p>
          ...
          {status === "error" && (
            <div className="text-sm text-rose-700 bg-rose-50 border border-rose-200 rounded-xl px-4 py-3">
              {errorMessage || "Something went wrong saving your listing."}
            </div>
          )}
